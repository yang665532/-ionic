...
export class RegisterPage implements OnInit {
  ...
  async signupUser(signupForm: FormGroup): Promise<void> {
    if (!signupForm.valid) {
      ...
      const profilePic: string = "assets/images/avatar.png";
     ...
     // this.router.navigate(['verify-email'], user);
      ...
      this.authService.registerUser(email, password, UserName, profilePic).then(
        () => {
          this.authService.setUserProfile(UserName, profilePic)
